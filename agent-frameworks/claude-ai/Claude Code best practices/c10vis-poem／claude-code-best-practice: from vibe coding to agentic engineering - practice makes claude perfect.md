# c10vis-poem／claude-code-best-practice: from vibe coding to agentic engineering - practice makes claude perfect
...
Add file
Code
This branch is up to date with shanraisshan/claude-code-best-practice:main .
Contribute
Sync fork
claude chore(badge): update Last Updated badge to Jul 29, 2026 11:37 AM PKT …
67c2696 · 20 hours ago
!
refactor(assets): redesign Disrupt.com part…
last month
.claude
fix(settings): drop unsupported "mcp__*" wil…
last month
.codex
updated codex hooks
2 months ago
...
3 months ago
best-practice
chore(badge): update Last Updated badge t…
20 hours ago
changelog
chore(changelog): append 2026-07-29 suba…
20 hours ago
development-workflows
adeed claude-oss banner
4 months ago
implementation
docs(implementation): add /goal implement…
2 months ago
...
4 months ago
README.md
chore(readme): bump Last Updated badge t…
yesterday
c10vis-poem
...
updated with Claude Code Jul 29, 2026 9:44 AM PKT
Jul 29, 2026 9:44 AM PKT
★64k
64k
Best Practice
Implemented
...
Ventures Reimagined
ClaudeKit
Production-ready skills and workﬂows
...
Dynamic
Workflows
/workflows , ultracode keyword, /effort ultracode ,
.claude/workflows/
Deep Research
🔥 Hot
...
isolation: "worktree" , WorktreeCreate / WorktreeRemove hooks
Best Practice
...
re-reviewer → test-driven-development
test-driven-development →
requesting-code-review
requesting-code-review → ﬁnal-code-reviewer
ﬁnal-code-reviewer → ﬁnishing-a-development-branch
...
124k
/speckit.install
/speckit.install → /speckit.init
/speckit.init → /speckit.constitution
...
65k
/gsd-new-project
/gsd-new-project → /gsd-explore
/gsd-explore → /gsd-spec-phase
/gsd-spec-phase → /gsd-plan-phase
/gsd-plan-phase → /gsd-execute-phase
/gsd-execute-phase
→ /gsd-review
/gsd-review → /gsd-validate-phase
/gsd-validate-phase → /gsd-ship
/gsd-ship
33
67
0
...
51k
bmad-brainstorming
bmad-brainstorming → bmad-agent-pm
bmad-agent-pm → bmad-prd
bmad-prd → bmad-agent-ux-designer
bmad-agent-ux-designer → bmad-ux
bmad-ux →
bmad-agent-architect
bmad-agent-architect → bmad-architecture
...
/ce-plan → /ce-work
/ce-work → /ce-simplify-code
/ce-simplify-code → /ce-code-review
...
11k
/ralph_research
/ralph_research → /create_plan
/create_plan → /iterate_plan
/iterate_plan → /validate_plan
/validate_plan → /implement_plan
/implement_plan →
/describe_pr
/describe_pr → /commit
/commit
...
Methodology: Cross-Model (Claude Code + Codex) Workflow
Implemented — manual two-terminal flow with Plan in Claude, QA-Review in
Codex.
Name
★
Type
Bridges to
What it does
musistudio/claude-code-
router
34k
Router
OpenRouter, DeepSeek,
Ollama, Gemini, Kimi, Qwen,
Groq, +more
Routes Claude Code's API to any compatible provider,
with per-task model selection
router-for-me/CLIProxyAPI
32k
Router
Gemini CLI, Codex, Claude
Code, Antigravity
Wraps each CLI as an OpenAI/Gemini/Claude/Codex-
compatible API service
openai/codex-plugin-cc
18k
Plugin
Codex / GPT-5
Official OpenAI plugin: /codex:review ,
/codex:adversarial-review , /codex:rescue inside
Claude Code
BeehiveInnovations/pal-
mcp-server
12k
MCP
Gemini, OpenAI, Azure, Grok,
Ollama, OpenRouter (50+
models)
Multi-model MCP server (formerly zen-mcp-server ) —
